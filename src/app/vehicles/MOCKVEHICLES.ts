...
export const MOCKVEHICLES: any[] = [
  ...
  },
  {
    ...
    vin: 'JTMRFREV0HD000003',
    mileage: 40000,
    color: 'White',
    description: 'A compact SUV with great fuel economy.',
    licensePlate: {
      state: 'FL',
